...
namespace Netgusto\Baikal\DavServicesBundle\Controller;
...
class CarddavController extends Controller
{
    public function indexAction() {
        ...
        if($this->container->getParameter('dav_carddav_enabled') !== TRUE) {
        ...
        $server->setBaseUri($this->generateUrl("netgusto_baikal_dav_services_carddav"));

        // Authentication plugin
        $authPlugin = new DAV\Auth\Plugin($authBackend, $this->container->getParameter('dav_realm'));
